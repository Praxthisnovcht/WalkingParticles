             ...
             case "h":
               if(isset($args[1])){
               	switch($args[1]):
               	 ...
               	 break;
               	 case 2:
               	   $issuer->sendMessage("§aShowing help page §6(2/2)");
               	   $issuer->sendMessage("§l§b- §r§f/walkp pack <use|create|delete|addp|rmp|get|list> <args..>");
               	   return true;
               	 break;
               	endswitch;
               }else{
               $issuer->sendMessage("§aShowing help page §6(1/2)");
               $issuer->sendMessage("§l§b- §r§f/walkp defaultparticle <particle>");
               $issuer->sendMessage("§l§b- §r§f/walkp defaultamplifier <amplifier>");
               $issuer->sendMessage("§l§b- §r§f/walkp add <particle> <player>");
               $issuer->sendMessage("§l§b- §r§f/walkp remove <particle> <player>");
               $issuer->sendMessage("§l§b- §r§f/walkp amplifier <amplifier> <player>");
               $issuer->sendMessage("§l§b- §r§f/walkp display line|group <player>");
               $issuer->sendMessage("§l§b- §r§f/walkp randomshow <player>");
               $issuer->sendMessage("§l§b- §r§f/walkp clear <player>");
               $issuer->sendMessage("§l§b- §r§f/walkp get <player>");
               $issuer->sendMessage("§l§b- §r§f/walkp list");
               return true;
              }
             break;
